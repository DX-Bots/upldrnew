...
async def OpenSettings(m: "types.Message"):
    ...
    buttons_markup = [
        [types.InlineKeyboardButton(f"ᴜᴘʟᴏᴀᴅ ᴀs {'🎥 ᴠɪᴅᴇᴏ' if upload_as_doc else '📂 Fɪʟᴇ'}",
    ...
    buttons_markup.append([types.InlineKeyboardButton("🔐 Cʟᴏsᴇ",
                                                      callback_data="close")])

    try:
        await m.edit(
            text="**Hᴇʀᴇ ʏᴏᴜ ᴄᴀɴ Sᴇᴛᴜᴘ ʏᴏᴜʀ Sᴇᴛᴛɪɴɢs**",
